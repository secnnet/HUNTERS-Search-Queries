...
--The queries you provided are selecting data from different tables in the SECNNET_ASIA_JAPAN.RAW database schema that store information related to security events and logs generated by different Cisco security products, such as AMP (Advanced Malware Protection), ASA (Adaptive Security Appliance), FTD (Firepower Threat Defense), and Umbrella DNS.
...
--This query retrieves the top 10 external IPs with the highest count of DNS queries that were blocked by Cisco Umbrella, from the SECNNET_ASIA_JAPAN.RAW.CISCO_UMBRELLA_DNS_LOGS table.
