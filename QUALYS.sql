...
--The first SQL query selects all columns (indicated by the asterisk symbol) from the "QUALYS_HOST_DETECTIONS" table in the "SECNNET_ASIA_JAPAN.RAW" database schema. The "Limit 10" clause limits the result set to the first 10 rows of data returned by the query.
