--This is a series of five SQL queries that are selecting data from different tables in the ICON_EU_DB database schema. The queries are retrieving the first 10 rows of data from each of the tables named in the query.
...
SELECT *
FROM ICON_EU_DB.RAW.SYMANTEC_DLP_LOGS
Limit 10

SELECT *
FROM ICON_EU_DB.RAW.SYMANTEC_ENDPOINT_PROTECTION_IDS_EVENTS
Limit 10

SELECT *
FROM ICON_EU_DB.RAW.SYMANTEC_ENDPOINT_PROTECTION_RISK_EVENTS
Limit 10

SELECT *
FROM ICON_EU_DB.RAW.SYMANTEC_ENDPOINT_PROTECTION_SCANS
Limit 10

SELECT *
FROM ICON_EU_DB.RAW.SYMANTEC_ENDPOINT_PROTECTION_SONAR_RAW
Limit 10
