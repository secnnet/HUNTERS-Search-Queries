...
--The queries are selecting data from the "SECNNET_ASIA_JAPAN" database, specifically from the "RAW" schema and three different tables named "CROWDSTRIKE_DETECTS", "CROWDSTRIKE_DEVICES", and "CROWDSTRIKE_RAW_EVENTS".
...
SELECT *
FROM SECNNET_ASIA_JAPAN.RAW.CROWDSTRIKE_DETECTS
Limit 10

SELECT *
FROM SECNNET_ASIA_JAPAN.RAW.CROWDSTRIKE_DEVICES
Limit 10

SELECT *
FROM SECNNET_ASIA_JAPAN.RAW.CROWDSTRIKE_RAW_EVENTS
Limit 10